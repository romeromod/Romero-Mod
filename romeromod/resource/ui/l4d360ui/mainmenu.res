"Resource/UI/MainMenu.res"
{
	...
	"BtnGameModes"
	{
		...
		"mode" [!$X360GUEST]
		{
			"id"				"BtnCustomMutations"
			"name"				"Romero Mod 2.0a"
			"image"				"vgui/menu_mode_mutation_romero"
			"command"			"FlmRomeroModFlyout"
			"menutitle"			"Romero Mod 2.0a"
			"menuhint"			"A more gritty, realistic zombie experience."
		}
